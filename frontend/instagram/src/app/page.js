  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-row gap-8 row-start-2 items-center sm:items-start">
        <Image src={`/images/home-phones-2x.png`} alt={"2 phones"} width="380" height="580" />
        ...
        <div>
          <main className="w-[350px] h-[500px] justify-items-center">
            ...
            <div className="flex mt-5 border w-[100%] h-[15%] items-center justify-items-center">
              <p className="mx-auto">Don't have an account? <Link className="hover:underline text-blue-600 hover:text-blue-800 visited:text-purple-600" href="/signup/">Sign up</Link></p>
            </div>
          </main>
